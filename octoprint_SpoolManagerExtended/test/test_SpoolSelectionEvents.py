...
#
# Run with:  .venv/bin/python -m pytest octoprint_SpoolManagerExtended/test/test_SpoolSelectionEvents.py -v
...
class FakePlugin(object):
    ...
    def __init__(self, databaseManager):
        ...
        # injected by OctoPrint's plugin loader in production; _sendPayload2EventBus
        # derives the event name prefix from it
...
class TestSpoolSelectionEvents(unittest.TestCase):
    ...
    def test_selectingDifferentSpoolFiresOneSelectedEvent(self):
        ...
        self.assertEqual(
            self._eventNames(), ["plugin_spoolmanagerextended_spool_selected"]
        )
    ...
    def test_clearingOccupiedToolFiresDeselected(self):
        ...
        self.assertEqual(
            self._eventNames(), ["plugin_spoolmanagerextended_spool_deselected"]
        )
    ...
    def test_movingSpoolBetweenToolsFiresDeselectThenSelect(self):
        ...
        self.assertEqual(
            self._eventNames(),
            [
                "plugin_spoolmanagerextended_spool_deselected",
                "plugin_spoolmanagerextended_spool_selected",
            ],
        )
