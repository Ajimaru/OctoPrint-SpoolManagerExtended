...
(function () {
    ...
    SpoolItem = function (spoolData, params) {
        ...
        this.minTemperature = ko.observable();
        this.maxTemperature = ko.observable();
        ...
        // Stable RFID matching key derived from the tag UID, separate from `code` - see
        // U1RfidManager.deriveRfidTagKey(). Not user-editable.
    ...
    SpoolItem.prototype.update = function (data, params) {
        ...
        this.minTemperature(updateData.minTemperature);
        this.maxTemperature(updateData.maxTemperature);
