...
#
# Run with:  python3 octoprint_SpoolManager/test/test_RfidTagUid.py
...
# Loaded by path rather than by package import: octoprint_SpoolManager/__init__.py pulls in
...
_ensurePackage("octoprint_SpoolManager", _PLUGIN_DIR)
_ensurePackage("octoprint_SpoolManager.common", _COMMON_DIR)
...
_loadModule(
    "octoprint_SpoolManager.common.SettingsKeys",
    os.path.join(_COMMON_DIR, "SettingsKeys.py"),
)
U1RfidManager = _loadModule(
    "octoprint_SpoolManager.U1RfidManager",
