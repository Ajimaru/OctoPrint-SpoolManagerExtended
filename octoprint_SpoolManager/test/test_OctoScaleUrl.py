...
class TestNormalizeOctoScaleUrl(unittest.TestCase):
    def test_bare_ip_gets_http_scheme(self):
        ...
        self.assertEqual(
            "http://192.168.1.139",
            OctoScaleUrl.normalizeOctoScaleUrl("192.168.1.139"),
        )
    ...
    def test_existing_http_scheme_is_kept(self):
        self.assertEqual(
            "http://192.168.1.139",
            OctoScaleUrl.normalizeOctoScaleUrl("http://192.168.1.139"),
        )
    ...
    def test_https_scheme_is_kept(self):
        ...
        self.assertEqual(
            "https://192.168.1.139",
            OctoScaleUrl.normalizeOctoScaleUrl("https://192.168.1.139"),
        )
    ...
    def test_port_is_kept(self):
        self.assertEqual(
            ...
            OctoScaleUrl.normalizeOctoScaleUrl("192.168.1.139:8080"),
        )
